...
function guardarResultados() {
    // Update a user
    var url = "http://localhost:30680/api/Seguimientoes/" + seguimiento.idSeguimiento;
...
var initSample = (function () {
    ...
    function getSeguimiento (idSeguimiento) {
        ...
        req.open("GET", "http://localhost:30680/api/Seguimientoes/"+idSeguimiento, false);
        ...
        // Petición HTTP GET síncrona hacia el archivo fotos.json del servidor
        req1.open("GET", "http://localhost:30680/api/Pacientes/" + seguimiento.idPaciente, false);
        // Envío de la petición
        req1.send(null);
        ...
        // Petición HTTP GET síncrona hacia el archivo fotos.json del servidor
        req2.open("GET", "http://localhost:30680/api/Medicos/" + seguimiento.idMedicoReferente, false);
        // Envío de la petición
        req2.send(null);   
        // Impresión por la consola de la respuesta recibida desde el servidor        
